    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="sidebar-aktif-disabled nav-item">
                    <a href="/admin" class="nav-link <?= $menu == 'dashboard' ? 'active disabled' : ''; ?>">
                ...
                <li class="sidebar-aktif-disabled nav-item">
                    <a href="/admin/post" class="nav-link <?= $menu == 'post' ? 'active disabled' : ''; ?>">
                ...
                <li class="sidebar-aktif-disabled nav-item">
                    <a href="/admin/pengguna" class="nav-link <?= $menu == 'pengguna' ? 'active disabled' : ''; ?>">
